...
function Footer() {
  return (
    <>
      ...
      <footer className="bg-primary-dark py-1 py-lg-3">
        <div className="container py-1 py-lg-3 mt-4 mt-mlg-3">
            ...
            <div className="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last item social pb-3">
              ...
              <div className="fw-bold d-flex align-items-center mb-2">
                <div className="input-group">
                  <input
                    className="form-control bg-transparent rounded-0 px-3 border-light text-white footer-newsletter"
                    type="text"
          ...
          <div
            ...
            style={{ right: 20 }}>
            <p className="mb-0 text-white small">Copyright © 2022 Brand</p>
            <a
