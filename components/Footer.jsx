      ...
      <footer className="text-white bg-dark py-2 py-lg-5">
        <div className="container py-3 py-lg-5 mt-4 mt-mlg-5">
          <div className="row justify-content-center">
            ...
            <div className="col-6 col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item mb-3">
              <h3 className="fs-6 text-white-50">About</h3>
              <ul className="list-unstyled">
                <li className="mb-1">
                  <a className="text-decoration-none text-white-50" href="#">
                    Company
                ...
                <li className="mb-1">
                  <a
                    className="link-light text-decoration-none text-white-50"
                    href="#">
                    Team
                  </a>
                </li>
            ...
            <div className="col-6 col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
              <h3 className="fs-6 text-white-50">001 (555) 4658 4758</h3>
              <ul className="list-unstyled">
                <li>
                  <a className="text-decoration-none text-white-50" href="#">
                    info@company.com
            ...
            <div className="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last item social pb-3">
              <h6 className="fw-normal text-white-50 mb-3">
