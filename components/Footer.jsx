          ...
          <div className="row justify-content-center">
              ...
              <ul className="list-unstyled">
                <li className="mb-1">
                  <Link href="/conferences">
                    <a className="text-decoration-none text-white-50 fs-6">
                      Conferences
                    </a>
                  </Link>
                </li>
                <li className="mb-1">
                  <Link href="/papers">
                    <a className="text-decoration-none text-white-50 fs-6">Papers</a>
                  </Link>
                </li>
                <li className="mb-1">
                  <Link href="/articles">
            ...
            <div className="col-6 col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item mb-3">
              ...
              <ul className="list-unstyled">
                ...
                <li className="mb-1">
                  <a
                    className="link-light text-decoration-none text-white-50 fs-6"
                    href="#">
                    Team
                  </a>
                </li>
            ...
            <div className="col-6 col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
              ...
              <ul className="list-unstyled">
                <li>
                  <a className="text-decoration-none text-white-50 fs-6 fs-6" href="#">
                    info@company.com
                  </a>
                </li>
              </ul>
              <ul className="list-inline mb-0">
                ...
                <li className="list-inline-item fs-4 ms-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
                    height="1em"
                    fill="currentColor"
                    viewBox="0 0 16 16"
                    className="bi bi-twitter text-white-50">
            ...
            <div className="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last item social pb-3">
              ...
              <div className="fw-bold d-flex align-items-center mb-2">
                <div className="input-group">
                  <input
                    className="form-control bg-transparent rounded-0 px-4 border-light"
                    type="text"
                    placeholder="Your email address"
                  />
                  <button
                    className="btn btn-primary bg-transparent border-light pb-1 rounded-0"
                    type="button">
